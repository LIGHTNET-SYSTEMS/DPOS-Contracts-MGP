...
namespace eosiosystem {
   ...
   static constexpr uint32_t seconds_per_half_year      = 26 * 7 * 24 * 3600;
   static constexpr uint32_t seconds_per_halving_time  = 603 * 24 * 3600;
   static constexpr int64_t  useconds_per_halving_time = int64_t(seconds_per_halving_time) * 1000'000ll;
   static constexpr int64_t  useconds_per_half_year     = int64_t(seconds_per_half_year) * 1000'000ll;

   static constexpr int64_t  min_activated_stake   = 75'000'000'0000;
   static constexpr int64_t  ram_gift_bytes        = 1400;
   static constexpr int64_t  min_pervote_daily_pay = 100;
   static constexpr int64_t  initial_mining_amount = 28791;
   static constexpr int64_t  premine_amount        = 200'000'000'0000;
