...
public:
   ...
   void create_core_token( symbol core_symbol = symbol{CORE_SYM} ) {
      ...
      create_currency( N(eosio.token), config::system_account_name, asset(5000000000000, core_symbol) );
      issue( asset(2000000000000, core_symbol) );
      BOOST_REQUIRE_EQUAL( asset(2000000000000, core_symbol), get_balance( "eosio", core_symbol ) );
   }
   ...
   void remaining_setup() {
      ...
      BOOST_REQUIRE_EQUAL( core_sym::from_string("200000000.0000"), get_balance("eosio")  + get_balance("eosio.ramfee") + get_balance("eosio.stake") + get_balance("eosio.ram") );
   }
   ...
   vector<name> active_and_vote_producers() {
      ...
      transfer( "eosio", "alice1111111", core_sym::from_string("70000000.0000"), "eosio" );
      BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_sym::from_string("35000000.0000"), core_sym::from_string("35000000.0000") ) );
      ...
      //vote for producers
      {
         transfer( config::system_account_name, "alice1111111", core_sym::from_string("70000000.0000"), config::system_account_name );
         BOOST_REQUIRE_EQUAL(success(), stake( "alice1111111", core_sym::from_string("20000000.0000"), core_sym::from_string("20000000.0000") ) );
         BOOST_REQUIRE_EQUAL(success(), buyram( "alice1111111", "alice1111111", core_sym::from_string("20000000.0000") ) );
